В стандартный пустой проект на django добавлены модель БД (Postgresql), 5 веб-страниц (2 на добавление узлов, 2 на редактирование узлов), и написаны функции во views.py.
